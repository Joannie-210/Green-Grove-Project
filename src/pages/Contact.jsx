    ...
    <div>
      ...
      <div className="lg:h-200 flex flex-col lg:flex-row justify-between lg:pt-15 items-start gap-10 min-w-full h-auto py-5 px-4 sm:px-10">
        <div className="hidden md:flex flex-col justify-start md:w-full w-150 max-w-4xl rounded-lg">
          <h1 className="text-2xl w-full md:text-5xl lg:text-4xl text-left font-bold mt-5 mb-4">
            Drop the line, let's chat
          </h1>
          <h2 className="text-xl text-gray-600 mb-6">
            Don't hesitate to say a hello!
          </h2>
      ...
      <button
        onClick={scrollToTop}
        className="fixed z-50 bottom-10 right-10 bg-green-600 text-white p-3 rounded-full shadow-lg hover:bg-green-700 transition duration-300 w-[50px] h-[50px] flex items-center justify-center hover:cursor-pointer"
      >
        <i className="bi bi-arrow-up text-xl"></i>
      </button>

      <h3 className="text-center text-3xl md:h-30 md:text-4xl h-20 flex justify-center items-center text-green-700 font-bold">
        Here marks our spot!
      </h3>
      <Map />
